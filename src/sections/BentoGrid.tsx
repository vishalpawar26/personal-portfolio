...
const BentoGrid = () => {
  ...
  return (
    <section className="z-10 flex w-full items-center justify-center bg-background px-4 py-12 sm:px-12">
      <div className="flex flex-col items-center gap-4 sm:gap-8 lg:w-[1024px]">
        ...
        <div className="spotlight-grid md-lg:flex-row flex flex-col gap-6">
          <div className="flex w-full flex-col gap-6">
            ...
            <div
              ref={aboutRef}
              className="h-2/5 w-full rounded-3xl border border-neutral-800 bg-gradient-to-bl from-gradientLight to-gradientDark p-px px-6 py-8 opacity-0 md:p-8 lg:py-12"
            >
          ...
          <div className="flex w-full flex-col gap-6">
            ...
            <div
              ...
              className="flex h-3/5 w-full flex-col gap-6 rounded-3xl border border-neutral-800 bg-gradient-to-bl from-gradientLight to-gradientDark p-px px-6 py-8 opacity-0 md:px-8 md:py-12"
            >
              <h3 className="text-xl font-light sm:text-2xl">
                Responsive Web.
              </h3>
            ...
            <div
              ref={gamesRef}
              className="flex h-2/5 flex-col items-center justify-between gap-8 overflow-hidden rounded-3xl border border-neutral-800 bg-gradient-to-bl from-gradientLight to-gradientDark p-px px-6 py-8 opacity-0 md:flex-row md:px-8 md:py-12"
            >
              <h3 className="w-full self-start text-xl font-light sm:text-2xl md:w-1/5">
                Playful Games.
              </h3>
