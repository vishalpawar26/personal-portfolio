    ...
    <section className="spotlight-grid z-10 flex w-full items-center justify-center bg-background px-4 py-12 sm:px-12">
      <div className="flex flex-col gap-8 lg:w-[1200px]">
        ...
        <div className="flex w-full flex-col gap-8 md:flex-row">
          ...
          >
            ...
            <p className="pt-3 text-base font-light text-neutral-400 sm:text-lg">
              ...
              specializing in creating immersive digital experiences and
              efficient web solutions. With extensive experience in both
              front-end and back-end development, I craft user-focused
              applications that combine technical excellence with creative
              innovation, ensuring seamless functionality and engaging user
              experiences across every project.
            </p>
          </div>
        ...
        >
          ...
          <div className="-mb-[2.75rem] -mr-16 md:-mb-16 md:mt-12 md:w-1/2">
            <video
              width="100%"
              loop
              muted
