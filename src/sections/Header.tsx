...
const Header = () => {
  ...
  return (
    <section className="bg-background/50 fixed inset-x-0 top-0 z-40 mx-auto min-w-80 border-b border-b-white/10 px-4 py-1 backdrop-blur-xl sm:px-12">
      <div className="mx-auto flex max-w-[1200px] justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div ref={menuRef} className="block md:hidden">
            ...
            <div
              className={`absolute right-4 top-14 z-10 flex w-60 transform flex-col rounded-2xl border border-neutral-700 bg-neutral-900 py-2 transition-opacity duration-300 ease-in-out sm:right-12 ${
