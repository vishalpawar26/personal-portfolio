...
const AboutMeCard = () => {
  ...
  return (
    <div
      className={`fixed inset-0 top-0 flex h-full w-full min-w-80 items-center justify-center bg-neutral-900/50 p-4 backdrop-blur-lg ${isAboutMeCardOpen ? "pointer-events-auto z-40 opacity-100" : "pointer-events-none opacity-0"} transition-all duration-300`}
    >
      <div ref={cardRef}>
        <div className="flex w-full flex-col gap-6 rounded-3xl bg-background p-6 shadow-2xl sm:w-[32rem] sm:p-8">
          ...
          <div className="flex flex-col gap-2">
            <p className="text-neutral-400">
              Hi, I am Vishal Pawar, full-stack developer with a strong
              foundation in Next.js, TypeScript, Tailwind CSS, MongoDB, and a
              passion for game development.
            </p>
            <p className="text-neutral-400">
              I enjoy creating interactive applications and games with a focus
              on user experience. Leveraging both front-end and back-end
